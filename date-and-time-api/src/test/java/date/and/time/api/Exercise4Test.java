...
public class Exercise4Test {
  ...
  public void zonedDateTimeOf() {
     ...
     */
    ZonedDateTime zonedDateTime = ZonedDateTime.of(LocalDateTime.parse("2015-07-10T02:14:25.000"), ZoneId.of("Asia/Tokyo"));
  ...
  public void toPST() {
     ...
     */
    ZonedDateTime zonedDateTime = ZonedDateTime.of(ldt, ZoneId.of(ZoneId.SHORT_IDS.get("PST")));
  ...
  public void sameInstantAs() {
     ...
     */
    ZonedDateTime zonedDateTime = zdt.withZoneSameInstant(ZoneId.of(ZoneId.SHORT_IDS.get("PST")));
  ...
  public void sameLocalAs() {
     ...
     */
    ZonedDateTime zonedDateTime = zdt.withZoneSameLocal(ZoneId.of(ZoneId.SHORT_IDS.get("PST")));
